...
// Module
exports.push([module.i, "/* This is an example of using Sass, otherwise plain CSS works too*/\n/* http://meyerweb.com/eric/tools/css/reset/ \n   v2.0 | 20110126\n   License: none (public domain)\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block; }\n\nbody {\n  line-height: 1; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\nbody {\n  font-family: \"Roboto\", sans-serif;\n  background-image: url(\"https://pbs.twimg.com/media/DHR906ZXkAAqs_f.jpg\");\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: 100vh; }\n\nmain {\n  width: 80%;\n  margin: auto;\n  margin-top: 5em; }\n\nh1 {\n  font-size: 6em;\n  padding: 20px;\n  text-align: center;\n  color: #fff;\n  width: 61%;\n  background: #989c8ef0;\n  display: block;\n  margin: auto;\n  margin-top: 40px;\n  border-radius: 4px;\n  font-family: 'Satisfy', cursive; }\n\n.tab-container ul {\n  margin: 0;\n  padding: 0; }\n\n.tab-container li {\n  list-style-type: none;\n  display: inline-block;\n  background: #c9ad86ed;\n  margin: 0;\n  padding: 11px 40px;\n  border-radius: 10px 10px 0 0;\n  color: #fff;\n  font-weight: 200;\n  cursor: pointer;\n  font-size: 40px;\n  font-family: 'Fira Sans Extra Condensed', sans-serif; }\n  .tab-container li:hover {\n    color: #fff;\n    background: #989c8ef0; }\n\n.tab-container ul li.active {\n  color: #fff;\n  background: #989c8ef0; }\n\n.tab-container .panel {\n  display: none;\n  background: #989c8ef0;\n  padding: 30px;\n  border-radius: 0 0 10px 10px; }\n\n.tab-container .panel.active {\n  display: block; }\n\n#panel1 {\n  display: flex;\n  justify-content: center;\n  flex-direction: column; }\n  #panel1 p {\n    text-align: center;\n    font-size: 27px;\n    margin: 20px; }\n  #panel1 div {\n    text-align: center;\n    font-size: 30px;\n    margin: 30px; }\n  #panel1 .hotel-main-tab {\n    display: flex;\n    justify-content: space-around; }\n  #panel1 button {\n    margin: auto;\n    display: block;\n    font-size: 2em;\n    padding: 10px;\n    border-radius: 4px;\n    border: none;\n    background: #c9ad86ed; }\n    #panel1 button:hover {\n      color: #fff;\n      background: #8AA4BF;\n      box-shadow: 5px 10px #888888; }\n\n.guest {\n  display: flex;\n  flex-direction: column;\n  margin: 20px; }\n  .guest h2 {\n    font-size: 3em;\n    margin: 10px; }\n  .guest .search-guest {\n    text-align: center;\n    margin: 20px; }\n    .guest .search-guest .search-for-guest-input {\n      font-size: 30px; }\n    .guest .search-guest .search-for-guest-button {\n      font-size: 30px;\n      border: none;\n      border-radius: 6px;\n      background: #c9ad86ed; }\n      .guest .search-guest .search-for-guest-button:hover {\n        color: #fff;\n        background: #8AA4BF;\n        box-shadow: 5px 10px #888888; }\n  .guest .default-guest {\n    text-align: center;\n    margin: 20px; }\n    .guest .default-guest input {\n      font-size: 30px;\n      border: none;\n      height: 36px;\n      border-radius: 4px; }\n    .guest .default-guest .add-guest-button {\n      font-size: 30px;\n      border: none;\n      width: 85px;\n      border-radius: 5px;\n      background: #c9ad86ed; }\n      .guest .default-guest .add-guest-button:hover {\n        color: #fff;\n        background: #8AA4BF;\n        box-shadow: 5px 10px #888888; }\n\n.bookings, .orders {\n  display: flex;\n  flex-direction: column;\n  text-align: center; }\n  .bookings .default-bookings, .orders .default-bookings {\n    display: flex;\n    justify-content: space-around; }\n  .bookings div, .orders div {\n    margin: 20px; }\n    .bookings div p, .orders div p {\n      font-size: 29px;\n      margin: 20px; }\n  .bookings .rooms-input, .orders .rooms-input {\n    font-size: 30px;\n    border: none;\n    height: 36px;\n    border-radius: 4px;\n    vertical-align: sub; }\n  .bookings button, .orders button {\n    font-size: 30px;\n    border: none;\n    border-radius: 5px;\n    background: #c9ad86ed;\n    margin: 12px;\n    vertical-align: middle; }\n    .bookings button:hover, .orders button:hover {\n      color: #fff;\n      background: #8AA4BF;\n      box-shadow: 5px 10px #888888; }\n\n.orders {\n  overflow: scroll;\n  max-height: 28em; }\n  .orders .orders-input {\n    font-size: 30px;\n    border: none;\n    height: 36px;\n    border-radius: 4px;\n    vertical-align: middle; }\n  .orders p {\n    font-size: 20px; }\n\n.info-container {\n  border: 1px solid black;\n  border-radius: 4px; }\n\n.guest-bookings, .show-rooms-container,\n.food-menu-container {\n  max-height: 16em;\n  overflow: scroll; }\n\n.show-rooms-container,\n.food-menu-container {\n  max-height: 233px; }\n\ntd {\n  width: 25%;\n  font-size: 24px; }\n\nth {\n  width: 14%;\n  font-size: 24px; }\n\nform {\n  margin: 10px; }\n\nh2 {\n  margin: 40px;\n  font-size: 40px; }\n\n.splash-page {\n  text-align: center;\n  font-size: 20em;\n  position: relative;\n  top: 35%;\n  animation: viva-venezuela infinite 3s linear; }\n\n@keyframes viva-venezuela {\n  from {\n    transform: rotate(0deg); }\n  to {\n    transform: rotate(360deg); } }\n", ""]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Bookings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Bookings */ "./src/Bookings.js");
...
class Customer {
  ...
  bookingsFromGuest() {
    // use chai spy here!!
    this.bookings = new _Bookings__WEBPACK_IMPORTED_MODULE_0__["default"](this.id, this.name, this.hotel);
  }
}
...
class Hotel {
  ...
  findExistingGuest(name, hotel) {
    if (this.searchGuestInData(name)) {
      this.customer = new _Customer__WEBPACK_IMPORTED_MODULE_0__["default"](this.searchGuestInData(name).id, name, hotel);
    } else {
      console.log('USER NOT FOUND')
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].userNotFound();
    }
  }
...
let domUpdates = {
  ...
  appendListOfGuests(hotelData) {
    hotelData.forEach((guest) => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-for-guest-input').append(`<option value="${guest.name}">${guest.name}</option>`)
    })
  },

  appendServicesForToday(services) {
    services.forEach((service) => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.all-orders-today').append(`
  ...
  appendOrdersBreakDown(orders) {
    orders.forEach((order) => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.room-service-breakdown').append(`
  ...
  appendGuestBookings(booking) {
    booking.forEach((room) => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bookings-summary').append(`<tr>
  ...
  appendHotelBookings(bookings, date) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-rooms-container').append(`
      <h3> ${date} </h3>
    <tr>
       <th>Room #</th>
       <th>Room Type</th>
  ...
  appendFoodMenu(menu) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.food-menu').append(`
       <tr>
         <th> Food </th>
         <th> Price </th>
       </tr>
  ...
  roomBooked(room, name) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.room-booked').append(`ROOM ${room} HAS BEEN BOOKED FOR ${name}!`)
  }
};
...
let hotel;
let today = _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].findCurrentDate();

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tab-container .tabs li').on('click', function(e) {
  e.preventDefault();
  let panelSelected = e.target.getAttribute('data-id');
    
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tab-container .panel.active').slideUp(300, function() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tab-container .panel.active').removeClass('active');
      
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + panelSelected).slideDown(300, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + panelSelected).addClass('active');
    });
  });
});
...
setTimeout( () => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.splash-page').show();
}, 1500);

setTimeout( () => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.splash-page').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').fadeIn(400);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('main').fadeIn(800);
  hotel = new _Hotel__WEBPACK_IMPORTED_MODULE_3__["default"](allData);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.revenue-today').html(hotel.revenueToday(today));
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.rooms-occupied-today').html(hotel.roomsPercentOccupiedToday(today));
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendListOfGuests(hotel.users);
  appendRooms();
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendServicesForToday(hotel.servicesForDay(today));
}, 5000);


jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-bookings').hide();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-orders').hide();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.food-menu-container').hide();


jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-for-guest-button').unbind().on('click', function(e) {
  e.preventDefault();
  let chosenGuest = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-for-guest-input').val();
  guestInfo(chosenGuest);
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.add-guest-button').unbind().on('click', function(e) {
  e.preventDefault();
  let newGuest = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.add-guest-input').val();
  guestInfo(newGuest)
})

function guestInfo(guestName) {
  hotel.addGuest(guestName);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('h1').text(guestName);
  hotel.findExistingGuest(guestName, hotel);
  appendOrders();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-bookings').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-orders').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.food-menu-container').show();
  
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.default-guest').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.default-bookings').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.default-orders').hide();
}

function appendRooms() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.most-popular-date').html(hotel.popularBookingDateAndRoomsAvailable('max'));
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.most-rooms-available').html(hotel.popularBookingDateAndRoomsAvailable('min'));
}

function appendOrders() {
  hotel.customer.bookingsFromGuest();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.room-service-total').html(hotel.customer.overallRoomServiceTotal());
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.money-spent-on-date').html(hotel.customer.totalRoomServiceToday(today));
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendOrdersBreakDown(hotel.customer.roomServiceBreakDown());
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendGuestBookings(hotel.customer.bookings.summaryOfGuestBookings());
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendFoodMenu(hotel.foodMenu());
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.back-to-default').on('click', function() {
  location.reload(true);
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.rooms-input-button').unbind().on('click', function(e) {
  e.preventDefault();
  let chosenDate = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.rooms-input').val();
  let formattedDate = chosenDate.replace(/-/gi, "/");
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].appendHotelBookings(hotel.roomsAvailableToday(formattedDate), formattedDate);

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-rooms-container').on('click', function(e) {
    e.preventDefault();
    let targetRoom = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).attr('data-id');
    let bookTheRoom = hotel.customer.bookings.bookRoom(formattedDate, targetRoom);
    _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].bookARoom(bookTheRoom);
    _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].roomBooked(targetRoom, hotel.customer.name);
  })
})
